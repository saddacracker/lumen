...
this.each(function(){init(this);});};$.fn.jqFancyTransitions.defaults={width:480,height:310,strips:1,delay:5000,stripDelay:50,titleOpacity:0.7,titleSpeed:1000,position:'alternate',direction:'fountainAlternate',effect:'curtain',navigation:false,links:false};})(jQuery);